      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> XYZ@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 63775XXXXX
            </p>
            <p>
              <i className="fa fa-home mr-3" /> JMIT, Radaur
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
          ...
          <MDBCol md="4" lg="4" className="ml-lg-0">
            <div className="text-center text-md-right">
              ...
              <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href="https://github.com/26manav09">
                    <i className="fab fa-github" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href='https://www.linkedin.com/in/manav-mehta-2609/'>
